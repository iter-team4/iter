    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="mt-16">
          ...
          >
            iter gives your team a single workspace to plan, build, and ship —
            without the noise. From idea to production, faster than ever.
          </p>
        </div>
        ...
        <div className="mt-auto">
          ...
          >
            ...
            <p
              ...
              style={{ color: "rgba(237,231,217,0.85)" }}
            >
            ...
            <div className="mt-4 flex items-center gap-3">
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, #D5A021, #A49694)",
